...
const PayrollForm = () => {
    ...
    const handlePreview = async (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            try {
                const response = await axios.post('http://hrm-service-be-1998239514.ap-south-1.elb.amazonaws.com/admin/preview-new-payslip', {
    ...
    const handleSaveAndSendPayRoll = async (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            try {
                const response = await axios.post('http://hrm-service-be-1998239514.ap-south-1.elb.amazonaws.com/admin/add-new-payroll', {
                    employeeId: employeeID,
                    payPeriod: payperiod,
                    payDate: payDate,
                    lopDays: LOP
